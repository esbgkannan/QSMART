...
java -classpath weka.jar weka.classifiers.trees.RandomForest -P 100 -I 100 -num-slots 1 -V 0.001 -S 1 -c 1 -x 10 -K 15 -M 15 -depth 15 -t ./upper_aerodigestive_tract_080_tmp.arff > ./upper_aerodigestive_tract_080.txt
