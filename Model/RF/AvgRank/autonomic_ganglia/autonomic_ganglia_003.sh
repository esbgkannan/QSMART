...
java -classpath weka.jar weka.classifiers.trees.RandomForest -P 100 -I 100 -num-slots 1 -V 0.001 -S 1 -c 1 -x 10 -K 0 -M 10 -depth 10 -t ./autonomic_ganglia_003_tmp.arff > ./autonomic_ganglia_003.txt
